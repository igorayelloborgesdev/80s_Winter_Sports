    ...
    {    
        try
        {
            if (this.GlobalPosition.Y < initYLimit)
            {
                ...
                if (this.GlobalPosition.X > 3.5f)
                {
                    this.Position = new Vector3(0.0f, initY, this.GlobalPosition.Z);
                }
                else if (this.GlobalPosition.X < -3.5f)
                {
                    this.Position = new Vector3(0.0f, initY, this.GlobalPosition.Z);
                }
                else if (this.GlobalPosition.Z > 11.0f)
                {
                    this.Position = new Vector3(this.GlobalPosition.X, initY, 0.0f);
                }
                else if (this.GlobalPosition.Z < -11.0f)
                {
                    this.Position = new Vector3(this.GlobalPosition.X, initY, 0.0f);
